...
#CROSS_COMPILE = arm_v5t_le_uclibc-
endif
ifeq ($(ARCH),i386)
ifeq ($(HOSTARCH),i386)
CROSS_COMPILE =
...
davinci_dm646x_config :    unconfig
	@$(MKCONFIG) $(@:_config=) arm arm926ejs davinci_dm646x

davinci_dm355_config :    unconfig
	@$(MKCONFIG) $(@:_config=) arm arm926ejs davinci_dm355

davinci_dm357_config :    unconfig
	@$(MKCONFIG) $(@:_config=) arm arm926ejs davinci_dm357
