...
struct nand_chip {
	...
	void		(*write_buf)(struct mtd_info *mtd, const u_char *buf, int len, int layout_idx, int index);
	void		(*read_buf)(struct mtd_info *mtd, u_char *buf, int len, int layout_idx, int index, int page);
